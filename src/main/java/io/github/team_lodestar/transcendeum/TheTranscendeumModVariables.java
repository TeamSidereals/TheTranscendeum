...
public class TheTranscendeumModVariables {
	public TheTranscendeumModVariables(TheTranscendeumModElements elements) {
	...
	public static boolean NoEnigmaCooldown = false;
	@CapabilityInject(PlayerVariables.class)
	public static Capability<PlayerVariables> PLAYER_VARIABLES_CAPABILITY = null;
	@SubscribeEvent
	public void onAttachCapabilities(AttachCapabilitiesEvent<Entity> event) {
		if (event.getObject() instanceof PlayerEntity && !(event.getObject() instanceof FakePlayer))
			event.addCapability(new ResourceLocation("the_transcendeum", "player_variables"), new PlayerVariablesProvider());
	}
