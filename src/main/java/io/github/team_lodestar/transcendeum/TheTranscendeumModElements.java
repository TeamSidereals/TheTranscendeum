...
public class TheTranscendeumModElements {
	...
	public TheTranscendeumModElements() {
		try {
			...
			for (ModFileScanData.AnnotationData annotationData : annotations) {
				if (annotationData.getAnnotationType().getClassName().equals(ModElement.Tag.class.getName())) {
					...
					if (clazz.getSuperclass() == TheTranscendeumModElements.ModElement.class)
						elements.add((TheTranscendeumModElements.ModElement) clazz.getConstructor(this.getClass()).newInstance(this));
				}
			}
		} catch (Exception e) {
			e.printStackTrace();
		...
		elements.forEach(TheTranscendeumModElements.ModElement::initElements);
		MinecraftForge.EVENT_BUS.register(new TheTranscendeumModVariables(this));
	}
