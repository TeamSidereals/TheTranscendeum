...
import io.github.team_lodestar.transcendeum.procedures.LkProcedure;
import io.github.team_lodestar.transcendeum.TheTranscendeumModElements;
import io.github.team_lodestar.transcendeum.TheTranscendeumMod;

@TheTranscendeumModElements.ModElement.Tag
public class EaKeyBinding extends TheTranscendeumModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public EaKeyBinding(TheTranscendeumModElements instance) {
		super(instance, 91);
	...
	public void initElements() {
		keys = new KeyBinding("key.the_transcendeum.ea", GLFW.GLFW_KEY_EQUAL, "key.categories.misc");
		...
		if (type == 0) {
			{
				...
				LkProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
