...
public class NoEnigmaGloveCooldownCommand {
	...
	public static void registerCommands(RegisterCommandsEvent event) {
		event.getDispatcher().register(LiteralArgumentBuilder.<CommandSource>literal("noenigmaglovecooldown")
	...
	private static int execute(CommandContext<CommandSource> ctx) {
		...
		NoEnigmaGloveCooldownCommandExecutedProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity))
