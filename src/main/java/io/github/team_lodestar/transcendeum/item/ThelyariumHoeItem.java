...
public class ThelyariumHoeItem extends TheTranscendeumModElements.ModElement {
	@ObjectHolder("the_transcendeum:thelyarium_hoe")
	public static final Item block = null;

	public ThelyariumHoeItem(TheTranscendeumModElements instance) {
		super(instance, 134);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("thelyarium_hoe"));
	}
}
