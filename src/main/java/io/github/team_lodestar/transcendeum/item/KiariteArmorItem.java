	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD,
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("\u00EF\u00BF\u00BD8A gear piece blessed by the power of the destructive winged lizards."));
				list.add(new StringTextComponent(
						"\u00EF\u00BF\u00BD6Adds a 5% chance to nullify any Trancendeum mobs' attacks while knocking them up, also regenerates 1 heart for the user when the effect takes place."));
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST,
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("\u00EF\u00BF\u00BD8A gear piece blessed by the power of the destructive winged lizards."));
				list.add(new StringTextComponent(
						"\u00EF\u00BF\u00BD6Adds a 9% chance to nullify any Trancendeum mobs' attacks while knocking them up, also regenerates 1 heart for the user when the effect takes place."));
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.LEGS,
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("\u00EF\u00BF\u00BD8A gear piece blessed by the power of the destructive winged lizards."));
				list.add(new StringTextComponent(
						"\u00EF\u00BF\u00BD6Adds a 6% chance to nullify any Trancendeum mobs' attacks while knocking them up, also regenerates 1 heart for the user when the effect takes place."));
			}
