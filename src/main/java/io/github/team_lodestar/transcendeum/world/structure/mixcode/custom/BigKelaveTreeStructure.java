...
public class BigKelaveTreeStructure extends Structure<NoFeatureConfig> {

    public BigKelaveTreeStructure() {
        super(NoFeatureConfig.field_236558_a_);
    }

    @Override
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return BigKelaveTreeStructure.Start::new;
    }
        ...
        public void func_230364_a_(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator,
            ...
            JigsawManager.func_242837_a(dynamicRegistryManager,
                    new VillageConfig(() -> dynamicRegistryManager.getRegistry(Registry.JIGSAW_POOL_KEY)
                            .getOrDefault(new ResourceLocation(TheTranscendeumMod.MODID, "big_kelave_tree_pool/start_pool")),
            ...
            LogManager.getLogger().log(Level.DEBUG, "Big Kelave tree at " +
