package io.github.team_lodestar.transcendeum.world.structure.mixcode.custom;
...
public class HandOfTheSandStructure extends Structure<NoFeatureConfig> {

    public HandOfTheSandStructure(){
        super(NoFeatureConfig.field_236558_a_);
    }

    @Override
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return HandOfTheSandStructure.Start::new;
    }
        ...
        public void func_230364_a_(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator,
            ...
            JigsawManager.func_242837_a(dynamicRegistryManager,
                    new VillageConfig(() -> dynamicRegistryManager.getRegistry(Registry.JIGSAW_POOL_KEY)
                            .getOrDefault(new ResourceLocation(TheTranscendeumMod.MODID, "hand_of_the_sand_pool/start_pool")),
            ...
            LogManager.getLogger().log(Level.DEBUG, "Hand of The Sand at " +
