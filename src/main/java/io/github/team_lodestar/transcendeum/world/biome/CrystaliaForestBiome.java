...
public class CrystaliaForestBiome extends TheTranscendeumModElements.ModElement {
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-11055767).setWaterColor(-4360492).setWaterFogColor(-4360492)
						.withSkyColor(-11055767).withFoliageColor(10387789).withGrassColor(9470285).build();
