...
@OnlyIn(Dist.CLIENT)
public class EnigmaGloveRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(EnigmaGloveItem.arrow, renderManager -> new CustomRender(renderManager));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public static class CustomRender extends EntityRenderer<EnigmaGloveItem.ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("the_transcendeum:textures/enigma_bullet_entity.png");
		public CustomRender(EntityRendererManager renderManager) {
			super(renderManager);
		}

		@Override
		public void render(EnigmaGloveItem.ArrowCustomEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn,
		...
		@Override
		public ResourceLocation getEntityTexture(EnigmaGloveItem.ArrowCustomEntity entity) {
			return texture;
		}
	}
