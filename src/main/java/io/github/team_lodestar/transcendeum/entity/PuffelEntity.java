...
import io.github.team_lodestar.transcendeum.entity.renderer.PuffelRenderer;
import io.github.team_lodestar.transcendeum.TheTranscendeumModElements;

@TheTranscendeumModElements.ModElement.Tag
public class PuffelEntity extends TheTranscendeumModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("puffel").setRegistryName("puffel");
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6697729, -154, new Item.Properties().group(TranscendeumMobsItemGroup.tab))
				.setRegistryName("puffel_spawn_egg"));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.CREATURE).add(new MobSpawnInfo.Spawners(entity, 14, 1, 4));
	}
