...
@OnlyIn(Dist.CLIENT) public class RemobrenRenderer {
		...
		@SubscribeEvent @OnlyIn(Dist.CLIENT) public void registerModels(ModelRegistryEvent event) {
				RenderingRegistry.registerEntityRenderingHandler(RemobrenEntity.entity, renderManager -> {
					return new MobRenderer(renderManager, new Modelremobren(), 0.5f) {
						...
						@Override public ResourceLocation getEntityTexture(Entity entity) { return new ResourceLocation("the_transcendeum:textures/remobren.png"); }
					};
				});
