...
@OnlyIn(Dist.CLIENT)
public class ExcrearerRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ExcrearerEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelexcecrear(), 1f) {
					{
	...
	private static class GlowingLayer<T extends Entity, M extends EntityModel<T>> extends LayerRenderer<T, M> {
		...
		public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, T entitylivingbaseIn, float limbSwing,
			...
			IVertexBuilder ivertexbuilder = bufferIn
					.getBuffer(RenderType.getEyes(new ResourceLocation("the_transcendeum:textures/excecrear_glow.png")));
	...
	public static class Modelexcecrear extends EntityModel<Entity> {
		...
		public Modelexcecrear() {
			...
			rotation_r1.setRotationPoint(-6.0F, -1.0F, 0.0F);
			rotation.addChild(rotation_r1);
			setRotationAngle(rotation_r1, 0.0F, 0.0F, -0.3927F);
			rotation_r1.setTextureOffset(60, 79).addBox(-15.697F, -0.8457F, -4.5F, 14.0F, 0.0F, 24.0F, 0.0F, true);
			rotation_r2 = new ModelRenderer(this);
			rotation_r2.setRotationPoint(6.0F, -1.0F, 0.0F);
			rotation.addChild(rotation_r2);
			setRotationAngle(rotation_r2, 0.0F, 0.0F, 0.3927F);
			rotation_r2.setTextureOffset(60, 79).addBox(1.697F, -0.8457F, -4.5F, 14.0F, 0.0F, 24.0F, 0.0F, false);
			...
			frontleg1.setRotationPoint(-5.5F, -3.0F, -8.0F);
			body.addChild(frontleg1);
			...
			leg3_r1.setRotationPoint(-0.5F, 6.0F, -6.0F);
			frontleg1.addChild(leg3_r1);
			setRotationAngle(leg3_r1, 0.9163F, 0.0F, 0.0F);
			leg3_r1.setTextureOffset(0, 0).addBox(-5.5F, -10.9812F, -3.4339F, 8.0F, 14.0F, 6.0F, 0.0F, false);
			leg4_r1 = new ModelRenderer(this);
			leg4_r1.setRotationPoint(-1.0F, -9.0F, 0.0F);
			leg3_r1.addChild(leg4_r1);
			setRotationAngle(leg4_r1, -1.5708F, 0.0F, 0.0F);
			leg4_r1.setTextureOffset(0, 34).addBox(-3.5F, -1.1182F, -3.6977F, 6.0F, 17.0F, 6.0F, 0.0F, false);
			frontleg2 = new ModelRenderer(this);
			frontleg2.setRotationPoint(5.5F, -3.0F, -8.0F);
			body.addChild(frontleg2);
			setRotationAngle(frontleg2, 0.0F, -0.4363F, 0.0F);
			leg2_r2 = new ModelRenderer(this);
			leg2_r2.setRotationPoint(0.5F, 2.0F, 16.0F);
			frontleg2.addChild(leg2_r2);
			setRotationAngle(leg2_r2, -0.7854F, 0.0F, 0.0F);
			leg2_r2.setTextureOffset(0, 57).addBox(-1.5F, 8.0F, -16.0F, 6.0F, 11.0F, 6.0F, 0.0F, true);
			leg3_r2 = new ModelRenderer(this);
			leg3_r2.setRotationPoint(0.5F, 6.0F, -6.0F);
			frontleg2.addChild(leg3_r2);
			setRotationAngle(leg3_r2, 0.9163F, 0.0F, 0.0F);
			leg3_r2.setTextureOffset(0, 0).addBox(-2.5F, -10.9812F, -3.4339F, 8.0F, 14.0F, 6.0F, 0.0F, true);
			leg4_r2 = new ModelRenderer(this);
			leg4_r2.setRotationPoint(1.0F, -9.0F, 0.0F);
			leg3_r2.addChild(leg4_r2);
			setRotationAngle(leg4_r2, -1.5708F, 0.0F, 0.0F);
			leg4_r2.setTextureOffset(0, 34).addBox(-2.5F, -1.1182F, -3.6977F, 6.0F, 17.0F, 6.0F, 0.0F, true);
		...
		public void setRotationAngles(Entity e, float f, float f1, float f2, float f3, float f4) {
			ExcrearerEntity.CustomEntity entityE = (ExcrearerEntity.CustomEntity) e;
			float pi = (float) Math.PI;
			{//basic settings
				head.rotationPointY = -24.5f;
				body.rotationPointY = 14;
				frontleg1.rotationPointY = -3;
				frontleg1.rotationPointZ = -8;
				frontleg2.rotationPointY = -3;
				frontleg2.rotationPointZ = -8;
			}
			this.head.rotateAngleY = f3 / (180F / (float) Math.PI);
			this.head.rotateAngleX = f4 / (180F / (float) Math.PI) - (1 + MathHelper.cos(f * 1.1F) * 0.06f) * f1 * 0.8f;
			head.rotationPointY += Math.abs(MathHelper.sin(f2 * 0.01f) * 3) * f1;
			body.rotateAngleX = (1 + MathHelper.cos(f * 1.1F) * 0.06f) * f1 * 0.8f;
			body.rotationPointY += MathHelper.sin(f2 * 0.01f) * 3 * f1;
			this.frontleg1.rotateAngleX = MathHelper.cos(f * 0.55F) * -1.0F * f1 * 0.7f - (1 + MathHelper.cos(f * 1.1F) * 0.06f) * f1 * 1.1f;
			this.leg3_r1.rotateAngleX = (MathHelper.cos(f * 0.55F)) * f1 * 1f + (float) Math.PI / 3.6f;
			this.leg4_r1.rotateAngleX = MathHelper.cos(f * 0.55F + (float) Math.PI * 0.3f) * -1.0F * f1 * 0.8f - (float) Math.PI / 2;
			this.frontleg2.rotateAngleX = MathHelper.cos(f * 0.55F) * 1.0F * f1 * 0.7f - (1 + MathHelper.cos(f * 1.1F) * 0.06f) * f1 * 1.1f;
			this.leg3_r2.rotateAngleX = (MathHelper.cos(f * 0.55F + (float) Math.PI)) * f1 * 1f + (float) Math.PI / 3.6f;
			this.leg4_r2.rotateAngleX = MathHelper.cos(f * 0.55F + (float) Math.PI * 0.3f) * 1.0F * f1 * 0.8f - (float) Math.PI / 2;
			this.backleg2.rotateAngleX = MathHelper.cos(f * 0.55F) * -1.0F * f1;
			this.backleg1.rotateAngleX = MathHelper.cos(f * 0.55F) * 1.0F * f1;
			if (entityE.isSwingInProgress) {
				if (entityE.getAttackState() == 1) {
