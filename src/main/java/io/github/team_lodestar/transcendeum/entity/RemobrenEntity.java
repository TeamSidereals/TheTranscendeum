...
@TheTranscendeumModElements.ModElement.Tag public class RemobrenEntity extends TheTranscendeumModElements.ModElement {

	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
					.immuneToFire().size(2f, 1f))
			.build("remobren").setRegistryName("remobren");
	...
	@Override public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -39424, -10079233,
				new Item.Properties().group(TranscendeumMobsItemGroup.tab))
				.setRegistryName("remobren_spawn_egg"));
	}
	...
	@SubscribeEvent public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		event.getSpawns().getSpawner(EntityClassification.AMBIENT).add(new MobSpawnInfo.Spawners(entity, 40,
			1, 3));
	}
	...
	@Override public void init(FMLCommonSetupEvent event) {
        ...
        RemobrenNaturalEntitySpawningConditionProcedure.executeProcedure(Stream.of(
...
this.goalSelector.addGoal(2, new RandomWalkingGoal(this, 1.8, 20) {
...
this.goalSelector.addGoal(3, new MeleeAttackGoal(this, 2, true));this.goalSelector.addGoal(4, new LookRandomlyGoal(this));this.targetSelector.addGoal(5,
        new NearestAttackableTargetGoal(this, PlayerEntity.class, true,
        false));this.targetSelector.addGoal(6,
        new NearestAttackableTargetGoal(this, GolemEntity.class, true,
        false));this.targetSelector.addGoal(7, new HurtByTargetGoal(this)
.setCallsForHelp(this.getClass()));
        ...
        RemobrenEntityIsHurtProcedure.executeProcedure(Stream.of(
...
;
        ...
        RemobrenOnInitialEntitySpawnProcedure.executeProcedure(Stream.of(
...
;
        ...
        RemobrenOnEntityTickUpdateProcedure.executeProcedure(Stream.of(
