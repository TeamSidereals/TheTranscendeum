...
public class TranscendentRayEntity extends TheTranscendeumModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(1f, 1f)).build("transcendent_ray").setRegistryName("transcendent_ray");

	public TranscendentRayEntity(TheTranscendeumModElements instance) {
		super(instance, 467);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TranscendentRayRenderer.ModelRegisterHandler());
	...
	public void init(FMLCommonSetupEvent event) {
		EntitySpawnPlacementRegistry.register(entity, EntitySpawnPlacementRegistry.PlacementType.NO_RESTRICTIONS,
				Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
					...
					int y = pos.getY();
					int z = pos.getZ();
					return TranscendentRayNaturalEntitySpawningConditionProcedure.executeProcedure(Stream
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public void baseTick() {
			...
			TranscendentRayOnEntityTickUpdateProcedure.executeProcedure(Stream
