...
public class SmoothSullenSandWallBlock extends TheTranscendeumModElements.ModElement {
	@ObjectHolder("the_transcendeum:smooth_sullen_sand_wall")
	public static final Block block = null;

	public SmoothSullenSandWallBlock(TheTranscendeumModElements instance) {
		super(instance, 440);
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("smooth_sullen_sand_wall");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("the_transcendeum:smooth_sullen_sand_wall_match"),
			...
			event.getRegistry().register(feature.setRegistryName("smooth_sullen_sand_wall"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("the_transcendeum:smooth_sullen_sand_wall"),
					configuredFeature);
		}
	}
