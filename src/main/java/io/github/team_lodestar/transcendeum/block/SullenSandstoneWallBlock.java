...
public class SullenSandstoneWallBlock extends TheTranscendeumModElements.ModElement {
	@ObjectHolder("the_transcendeum:sullen_sandstone_wall")
	public static final Block block = null;

	public SullenSandstoneWallBlock(TheTranscendeumModElements instance) {
		super(instance, 437);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("sullen_sandstone_wall");
		}
