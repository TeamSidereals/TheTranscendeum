...
public class PurpureanGrassBlockBlock extends TheTranscendeumModElements.ModElement {
	@ObjectHolder("the_transcendeum:purpurean_grass_block")
	public static final Block block = null;

	public PurpureanGrassBlockBlock(TheTranscendeumModElements instance) {
		super(instance, 407);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("purpurean_grass_block");
		}
