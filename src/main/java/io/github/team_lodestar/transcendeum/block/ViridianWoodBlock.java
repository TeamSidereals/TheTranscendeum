...
public class ViridianWoodBlock extends TheTranscendeumModElements.ModElement {

	@ObjectHolder("the_transcendeum:viridian_wood")
	public static final Block block = null;

	public ViridianWoodBlock(TheTranscendeumModElements instance) {
		super(instance, 94);
