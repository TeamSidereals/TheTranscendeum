...
public class ViridianStairsBlock extends TheTranscendeumModElements.ModElement {
	@ObjectHolder("the_transcendeum:viridian_stairs")
	public static final Block block = null;
	public ViridianStairsBlock(TheTranscendeumModElements instance) {
		super(instance, 104);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("viridian_stairs");
		}
