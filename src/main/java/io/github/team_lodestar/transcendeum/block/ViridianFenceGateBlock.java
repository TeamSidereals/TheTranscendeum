...
public class ViridianFenceGateBlock extends TheTranscendeumModElements.ModElement {

	@ObjectHolder("the_transcendeum:viridian_fence_gate")
	public static final Block block = null;

	public ViridianFenceGateBlock(TheTranscendeumModElements instance) {
		super(instance, 98);
	...
	public static class CustomBlock extends FenceGateBlock {
		...
		public CustomBlock() {
			...
			setRegistryName("viridian_fence_gate");
		}
