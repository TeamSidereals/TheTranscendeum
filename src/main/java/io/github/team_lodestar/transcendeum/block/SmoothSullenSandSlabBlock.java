...
public class SmoothSullenSandSlabBlock extends TheTranscendeumModElements.ModElement {
	@ObjectHolder("the_transcendeum:smooth_sullen_sand_slab")
	public static final Block block = null;

	public SmoothSullenSandSlabBlock(TheTranscendeumModElements instance) {
		super(instance, 439);
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("smooth_sullen_sand_slab");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("the_transcendeum:smooth_sullen_sand_slab_match"),
			...
			event.getRegistry().register(feature.setRegistryName("smooth_sullen_sand_slab"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("the_transcendeum:smooth_sullen_sand_slab"),
					configuredFeature);
		}
	}
