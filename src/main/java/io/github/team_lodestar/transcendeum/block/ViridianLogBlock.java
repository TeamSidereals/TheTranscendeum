...
public class ViridianLogBlock extends TheTranscendeumModElements.ModElement {
	@ObjectHolder("the_transcendeum:viridian_log")
	public static final Block block = null;
	public ViridianLogBlock(TheTranscendeumModElements instance) {
		super(instance, 95);
	}
