...
public class ViridianMossBlock extends TheTranscendeumModElements.ModElement {
	@ObjectHolder("the_transcendeum:viridian_moss")
	public static final Block block = null;

	public ViridianMossBlock(TheTranscendeumModElements instance) {
		super(instance, 477);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("the_transcendeum:viridian_moss_match"),
			...
			event.getRegistry().register(feature.setRegistryName("viridian_moss"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("the_transcendeum:viridian_moss"), configuredFeature);
		}
	}
