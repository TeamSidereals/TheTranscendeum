...
public class ViridianSlabBlock extends TheTranscendeumModElements.ModElement {

	@ObjectHolder("the_transcendeum:viridian_slab")
	public static final Block block = null;

	public ViridianSlabBlock(TheTranscendeumModElements instance) {
		super(instance, 97);
