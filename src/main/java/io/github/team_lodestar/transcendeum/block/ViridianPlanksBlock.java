...
public class ViridianPlanksBlock extends TheTranscendeumModElements.ModElement {

	@ObjectHolder("the_transcendeum:viridian_planks")
	public static final Block block = null;

	public ViridianPlanksBlock(TheTranscendeumModElements instance) {
		super(instance, 96);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("viridian_planks");
		}
