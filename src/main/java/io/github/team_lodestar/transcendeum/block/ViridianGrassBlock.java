...
public class ViridianGrassBlock extends TheTranscendeumModElements.ModElement {
	@ObjectHolder("the_transcendeum:viridian_grass")
	public static final Block block = null;

	public ViridianGrassBlock(TheTranscendeumModElements instance) {
		super(instance, 479);
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.POISON, 5, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.PLANT)
		...
		public boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
			...
			return (ground == ViridianMossBlock.block || ground == VerdureBlockBlock.block
