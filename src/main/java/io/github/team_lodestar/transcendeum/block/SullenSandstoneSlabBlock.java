...
public class SullenSandstoneSlabBlock extends TheTranscendeumModElements.ModElement {
	@ObjectHolder("the_transcendeum:sullen_sandstone_slab")
	public static final Block block = null;

	public SullenSandstoneSlabBlock(TheTranscendeumModElements instance) {
		super(instance, 436);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("sullen_sandstone_slab");
		}
