...
public class VerdureBlockBlock extends TheTranscendeumModElements.ModElement {
	@ObjectHolder("the_transcendeum:verdure_block")
	public static final Block block = null;

	public VerdureBlockBlock(TheTranscendeumModElements instance) {
		super(instance, 478);
	}
