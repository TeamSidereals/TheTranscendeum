...
public class ViridianFenceBlock extends TheTranscendeumModElements.ModElement {
	@ObjectHolder("the_transcendeum:viridian_fence")
	public static final Block block = null;
	public ViridianFenceBlock(TheTranscendeumModElements instance) {
		super(instance, 99);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("viridian_fence");
		}
