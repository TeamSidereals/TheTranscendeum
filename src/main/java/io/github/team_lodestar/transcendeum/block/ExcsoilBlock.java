...
public class ExcsoilBlock extends TheTranscendeumModElements.ModElement {
	@ObjectHolder("the_transcendeum:excsoil")
	public static final Block block = null;

	public ExcsoilBlock(TheTranscendeumModElements instance) {
		super(instance, 480);
	}
