...
public class SullenSandstoneBlock extends TheTranscendeumModElements.ModElement {
	@ObjectHolder("the_transcendeum:sullen_sandstone")
	public static final Block block = null;
	public SullenSandstoneBlock(TheTranscendeumModElements instance) {
		super(instance, 10);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sullen_sandstone");
		}
