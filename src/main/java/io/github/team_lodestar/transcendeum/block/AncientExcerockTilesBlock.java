...
public class AncientExcerockTilesBlock extends TheTranscendeumModElements.ModElement {
	@ObjectHolder("the_transcendeum:ancient_excerock_tiles")
	public static final Block block = null;
	public AncientExcerockTilesBlock(TheTranscendeumModElements instance) {
		super(instance, 91);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ancient_excerock_tiles");
		}
